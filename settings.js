...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~JzUy0JIZ#qxnwuM9swVfrie4lGvqwpxSPk6XqmnebjRVOQBwM9oo",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || "!",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "DIVINE-XD",
...
// add bot owner name
              ...
              DESCRIPTION: process.env.DESCRIPTION || "*© Divine technologies*",
// add bot owner name    
